...
var Tab = /** @class */ (function () {
    ...
    Tab.prototype.move = function (top) {
        this.container.style.top = top + 'px';
    };
    Tab.prototype.showPrompts = function (input, cursorPos) {
        var prompts = this.handler(input, cursorPos);
        if (!prompts) {
            return;
        }
...
var IOTerm = /** @class */ (function () {
    ...
    IOTerm.prototype.addEventListeners = function () {
        ...
        this.input.addEventListener('input', function (event) {
            ...
            if (_this.tab.count !== 0) {
                _this.tab.init();
                _this.tab.showPrompts(_this.input.value, _this.input.selectionStart);
                _this.moveTab();
            }
        });
            ...
            switch (event.keyCode) {
                case 13: // Enter
                    if (_this.tab.count === 0) {
                        ...
                        _this.insert(_this.tab.panel
                            .children[_this.tab.count - 1].innerText);
                        _this.tab.init();
                    }
                    break;
                // Moving the cursor.
                case 37: // Left
                    ...
                    if (index >= 0) {
                        ...
                        _this.moveCursor({
                            numRows: _this.main.numRows + wrap.numRows - 1,
                            colOffset: wrap.colOffset,
    ...
    IOTerm.prototype.insert = function (html) {
        var text = this.input.value;
        var cursorPos = this.input.selectionStart;
        var preText = text.substring(0, cursorPos) + html;
    ...
    IOTerm.prototype.moveCursor = function (_a) {
        var numRows = _a.numRows, colOffset = _a.colOffset, character = _a.character, scroll = _a.scroll;
        var charWidth;
        if (!character) {
            character = '&nbsp;';
        ...
        var top = this.minChar.height * (numRows - 1);
    ...
    IOTerm.prototype.moveTab = function () {
        this.tab.move(this.main.panel.offsetHeight + this.main.tmpPanel.offsetHeight);
    };
