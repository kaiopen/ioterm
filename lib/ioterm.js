...
var IOTerm = /** @class */ (function () {
    function IOTerm(parentElement) {
        ...
        this.term.append(this.measurement, this.input, this.container, this.tabPanel, this.cursor);
    ...
    IOTerm.prototype.addEventListeners = function () {
        ...
        this.input.addEventListener('keydown', function (event) {
            ...
            switch (event.keyCode) {
                ...
                case 9: // Tab
                    console.log('Tab');
                    if (_this.promptIndex === -1) {
                        var prompts = _this.tabHandler(_this.input.value.trim());
                        var prompt_1;
                        for (var i = ++_this.promptIndex; (i < _this.promptIndex + 4) && (i < prompts.length); i++) {
                            prompt_1 = prompts[i];
                            var item_1 = document.createElement('div');
                            item_1.style.display = 'inline-block';
                            item_1.style.height = '100%';
                            item_1.style.paddingLeft = '10px';
                            item_1.style.paddingRight = '10px';
                            item_1.innerHTML = i + '. ' + prompt_1;
                            _this.tabPanel.append(item_1);
                        }
                        _this.promptIndex++;
                    }
                    break;
