...
var IOTerm = /** @class */ (function () {
    function IOTerm(parentElement) {
        var _this = this;
        var shadow = parentElement.attachShadow({ mode: 'closed' });
    ...
    IOTerm.prototype.setMargin = function (margin) {
        this.term.style.margin = margin;
    };
    IOTerm.prototype.setPadding = function (padding) {
